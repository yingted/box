...
export COLLECT_GCC_OPTIONS="'-o' 'box' '-O3' '-shared-libgcc' '-mtune=generic' '-march=i686' `pkg-config --cflags --libs libseccomp`"
COLLECT_GCC=g++ \
